      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <h1 className="text-muted pt-80">Terms & Condition</h1>
            <hr />
            <div>
              ...
              <br />
              <p>
                This website is operated by Beezhive. Throughout the site, the
                terms “we”, “us” and “our” refer to BeezBag. BeezBag offers this
              ...
              <p>
                SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES (if
                applicable)
              </p>
              <br />

              <p>
                Prices for our products are subject to change without notice (if
                applicable).
              </p>
              <br />
              <p>
              ...
              <br />
              <p>
                In no case shall BeezBag, our directors, officers, employees,
              ...
              <p>
                You agree to indemnify, defend and hold harmless BeezBag and our
